...
const groupSchema = new Schema({
    ...
    joinRequestsAcceptedPercentage : Number,
    joinRequestsAcceptedPercentageString : String,
    joinRequestsRejected : Number,
    joinRequestsRejectedPercentage : Number,
    joinRequestsRejectedPercentageString : String,
    joinRequestsPending : Number,
    joinRequestsPendingPercentage : Number,
    joinRequestsPendingPercentageString : String,
    joinCode : String,
