...
let updateTask = (email , newTask)=>{
    Task.findOneAndUpdate({userEmail : email,taskId : newTask.taskId} , newTask);
}

let deleteTask = (email , taskId)=>{
    return Task.findOneAndDelete({userEmail : email,taskId : taskId});
}
